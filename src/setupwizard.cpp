...
void SetupWizard::importMameIni()
{
	...
	QStringList allOptions(QStringList() << "adstick_device" << "artpath" << "artwork_crop" << "artwork_font" << "aspect" << "aspect0" << "aspect1" << "aspect2" << "aspect3" << "attach_window" << "audiodriver" << "audio_latency" << "autoboot_command" << "autoboot_delay" << "autoboot_script" << "autoframeskip" << "autorol" << "autoror" << "autosave" << "autostretchxy" << "aviwrite" << "background_input" << "beam_dot_size" << "beam_intensity_weight" << "beam_width_max" << "beam_width_min" << "bench" << "bgfx_avi_name" << "bgfx_backend" << "bgfx_debug" << "bgfx_lut" << "bgfx_path" << "bgfx_screen_chains" << "bgfx_shadow_mask" << "bios" << "bloom_blend_mode" << "bloom_lvl0_weight" << "bloom_lvl1_weight" << "bloom_lvl2_weight" << "bloom_lvl3_weight" << "bloom_lvl4_weight" << "bloom_lvl5_weight" << "bloom_lvl6_weight" << "bloom_lvl7_weight" << "bloom_lvl8_weight" << "bloom_overdrive" << "bloom_scale" << "blu_ratio" << "brightness" << "burnin" << "centerh" << "centerv" << "cfg_directory" << "cheat" << "cheatpath" << "chroma_a" << "chroma_b" << "chroma_c" << "chroma_conversion_gain" << "chroma_mode" << "chroma_y_gain" << "coin_impulse" << "coin_lockout" << "comment_directory" << "comm_framesync" << "comm_localhost" << "comm_localport" << "comm_remotehost" << "comm_remoteport" << "compressor" << "confirm_quit" << "console" << "contrast" << "controller_map" << "converge_x" << "converge_y" << "crosshairpath" << "ctrlr" << "ctrlrpath" << "cubic_distortion" << "debug" << "debugger" << "debugger_font" << "debugger_font_size" << "debugger_host" << "debugger_port" << "debuglog" << "debugscript" << "defocus" << "dial_device" << "diff_directory" << "distort_corner" << "distortion" << "drc" << "drc_log_native" << "drc_log_uml" << "drc_rwx" << "drc_use_c" << "dual_lightgun" << "effect" << "enable_touch" << "exit_after_playback" << "fallback_artwork" << "filter" << "flicker" << "flipx" << "flipy" << "floor" << "fontpath" << "frameskip" << "full_screen_brightness" << "full_screen_contrast" << "full_screen_gamma" << "gamma" << "gl_forcepow2texture" << "gl_glsl" << "gl_glsl_filter" << "gl_lib" << "gl_notexturerect" << "global_inputs" << "gl_pbo" << "glsl_shader_mame0" << "glsl_shader_mame1" << "glsl_shader_mame2" << "glsl_shader_mame3" << "glsl_shader_mame4" << "glsl_shader_mame5" << "glsl_shader_mame6" << "glsl_shader_mame7" << "glsl_shader_mame8" << "glsl_shader_mame9" << "glsl_shader_screen0" << "glsl_shader_screen1" << "glsl_shader_screen2" << "glsl_shader_screen3" << "glsl_shader_screen4" << "glsl_shader_screen5" << "glsl_shader_screen6" << "glsl_shader_screen7" << "glsl_shader_screen8" << "glsl_shader_screen9" << "gl_vbo" << "grn_ratio" << "hashpath" << "hlsl_enable" << "hlsl_oversampling" << "hlslpath" << "hlsl_snap_height" << "hlsl_snap_width" << "hlsl_write" << "homepath" << "http" << "http_port" << "http_root" << "hum_bar_alpha" << "inipath" << "input_directory" << "intoverscan" << "intscalex" << "intscaley" << "joystick" << "joystick_contradictory" << "joystick_deadzone" << "joystick_map" << "joystickprovider" << "joystick_saturation" << "joystick_threshold" << "keepaspect" << "keyboardprovider" << "keymap" << "keymap_file" << "language" << "languagepath" << "lightgun" << "lightgun_device" << "lightgun_index1" << "lightgun_index2" << "lightgun_index3" << "lightgun_index4" << "lightgun_index5" << "lightgun_index6" << "lightgun_index7" << "lightgun_index8" << "lightgunprovider" << "log" << "lowlatency" << "lut_enable" << "lut_texture" << "maximize" << "menu" << "midiprovider" << "mngwrite" << "monitorprovider" << "mouse" << "mouse_device" << "mouseprovider" << "multikeyboard" << "multimouse" << "natural" << "networkprovider" << "noplugin" << "numprocessors" << "numscreens" << "nvram_directory" << "nvram_save" << "offscreen_reload" << "offset" << "oslog" << "output" << "override_artwork" << "pa_api" << "paddle_device" << "pa_device" << "pa_latency" << "pause_brightness" << "pedal_device" << "phosphor_life" << "playback" << "plugin" << "plugins" << "pluginspath" << "positional_device" << "power" << "prescale" << "priority" << "profile" << "radial_converge_x" << "radial_converge_y" << "ramsize" << "readconfig" << "record" << "red_ratio" << "reflection" << "refreshspeed" << "renderdriver" << "resolution" << "resolution0" << "resolution1" << "resolution2" << "resolution3" << "rewind" << "rewind_capacity" << "rol" << "rompath" << "ror" << "rotate" << "round_corner" << "samplepath" << "samplerate" << "samples" << "saturation" << "scale" << "scalemode" << "scanline_alpha" << "scanline_bright_offset" << "scanline_bright_scale" << "scanline_height" << "scanline_jitter" << "scanline_size" << "scanline_variation" << "screen" << "screen0" << "screen1" << "screen2" << "screen3" << "sdlvideofps" << "seconds_to_run" << "shadow_mask_alpha" << "shadow_mask_texture" << "shadow_mask_tile_mode" << "shadow_mask_uoffset" << "shadow_mask_usize" << "shadow_mask_voffset" << "shadow_mask_vsize" << "shadow_mask_x_count" << "shadow_mask_y_count" << "share_directory" << "sixaxis" << "skip_gameinfo" << "sleep" << "smooth_border" << "snapbilinear" << "snapname" << "snapshot_directory" << "snapsize" << "snapview" << "sound" << "speaker_report" << "speed" << "state" << "state_directory" << "statename" << "steadykey" << "switchres" << "swpath" << "syncrefresh" << "throttle" << "trackball_device" << "triplebuffer" << "ui" << "ui_active" << "uifont" << "uifontprovider" << "ui_lut_enable" << "ui_lut_texture" << "uimodekey" << "ui_mouse" << "unevenstretch" << "unevenstretchx" << "unevenstretchy" << "update_in_pause" << "useallheads" << "vector_beam_smooth" << "vector_length_ratio" << "vector_length_scale" << "verbose" << "video" << "videodriver" << "view" << "view0" << "view1" << "view2" << "view3" << "vignetting" << "volume" << "waitvsync" << "watchdog" << "wavwrite" << "window" << "writeconfig" << "yiq_a" << "yiq_b" << "yiq_cc" << "yiq_enable" << "yiq_i" << "yiq_jitter" << "yiq_n" << "yiq_o" << "yiq_p" << "yiq_phase_count" << "yiq_q" << "yiq_scan_time" << "yiq_y");
	QStringList booleanOptions(QStringList() << "artwork_crop" << "autoframeskip" << "autorol" << "autoror" << "autosave" << "autostretchxy" << "background_input" << "bgfx_debug" << "burnin" << "centerh" << "centerv" << "cheat" << "coin_lockout" << "comm_framesync" << "compressor" << "confirm_quit" << "console" << "debug" << "debuglog" << "drc" << "drc_log_native" << "drc_log_uml" << "drc_rwx" << "drc_use_c" << "dual_lightgun" << "enable_touch" << "exit_after_playback" << "filter" << "flipx" << "flipy" << "gl_forcepow2texture" << "gl_glsl" << "gl_notexturerect" << "global_inputs" << "gl_pbo" << "gl_vbo" << "hlsl_enable" << "hlsl_oversampling" << "http" << "intoverscan" << "joystick" << "joystick_contradictory" << "keepaspect" << "keymap" << "lightgun" << "log" << "lowlatency" << "lut_enable" << "maximize" << "menu" << "mouse" << "multikeyboard" << "multimouse" << "natural" << "nvram_save" << "offscreen_reload" << "oslog" << "plugins" << "readconfig" << "refreshspeed" << "rewind" << "rol" << "ror" << "rotate" << "samples" << "sdlvideofps" << "sixaxis" << "skip_gameinfo" << "sleep" << "snapbilinear" << "steadykey" << "switchres" << "syncrefresh" << "throttle" << "triplebuffer" << "ui_active" << "ui_lut_enable" << "ui_mouse" << "unevenstretch" << "unevenstretchx" << "unevenstretchy" << "update_in_pause" << "useallheads" << "verbose" << "waitvsync" << "window" << "writeconfig" << "yiq_enable");
	QStringList floatOptions(QStringList() << "beam_dot_size" << "beam_intensity_weight" << "beam_width_max" << "beam_width_min" << "bloom_lvl0_weight" << "bloom_lvl1_weight" << "bloom_lvl2_weight" << "bloom_lvl3_weight" << "bloom_lvl4_weight" << "bloom_lvl5_weight" << "bloom_lvl6_weight" << "bloom_lvl7_weight" << "bloom_lvl8_weight" << "bloom_overdrive" << "bloom_scale" << "blu_ratio" << "brightness" << "chroma_a" << "chroma_b" << "chroma_c" << "chroma_conversion_gain" << "chroma_y_gain" << "contrast" << "converge_x" << "converge_y" << "cubic_distortion" << "defocus" << "distort_corner" << "distortion" << "flicker" << "floor" << "full_screen_brightness" << "full_screen_contrast" << "full_screen_gamma" << "gamma" << "grn_ratio" << "hum_bar_alpha" << "joystick_deadzone" << "joystick_saturation" << "joystick_threshold" << "offset" << "pa_latency" << "pause_brightness" << "phosphor_life" << "power" << "radial_converge_x" << "radial_converge_y" << "red_ratio" << "reflection" << "round_corner" << "saturation" << "scale" << "scanline_alpha" << "scanline_bright_offset" << "scanline_bright_scale" << "scanline_height" << "scanline_jitter" << "scanline_size" << "scanline_variation" << "shadow_mask_alpha" << "shadow_mask_uoffset" << "shadow_mask_usize" << "shadow_mask_voffset" << "shadow_mask_vsize" << "smooth_border" << "speed" << "vector_beam_smooth" << "vector_length_ratio" << "vector_length_scale" << "vignetting" << "yiq_a" << "yiq_b" << "yiq_cc" << "yiq_i" << "yiq_jitter" << "yiq_n" << "yiq_o" << "yiq_p" << "yiq_q" << "yiq_scan_time" << "yiq_y");
